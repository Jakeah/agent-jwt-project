...
# Authentication — email/password, sessions [https://github.com/heartcombo/devise]
gem "devise"
# Mint RS256 identity-verification JWTs for Agentforce User Verification [https://github.com/jwt/ruby-jwt]
gem "jwt"
